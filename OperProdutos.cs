...
{
    public partial class OperProdutos : Form
    {
        ...
        private void ConfigurarGrid()
        {
            ...
            dataGrid1.Columns[2].Visible = false;   // ID
            dataGrid1.Columns[3].Width = 100;       // Data
            dataGrid1.Columns[4].Width = 80;        // Código
            dataGrid1.Columns[5].Width = 50;        // Quantidade
            dataGrid1.Columns[6].Width = 80;        // Marca
            dataGrid1.Columns[7].Width = 150;       // Descrição
            dataGrid1.Columns[8].Visible = false;  // UID
            dataGrid1.Columns[9].Width = 130;      // Tipo - colocado o texto
            dataGrid1.Columns[10].Visible = false;  // Tipo valor original
            dataGrid1.Columns[11].Visible = false;  // idForn
            dataGrid1.Columns[12].Width = 100;      // Obs
