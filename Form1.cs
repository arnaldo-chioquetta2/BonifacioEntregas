        ...
        private bool VerificaNovaVersao(Version version)
        {
            ...
            if (atualizar)
            {
                ...
                if (URL.Length > 0)
                {
                    ...
                    if (versaoFtp==-1)
                    {
                        this.Text = "Não foi possível procurar nova versão";
                    }
            ...
            else
            {
                switch (glo.Nivel)
                {
                    case 0: // Balconista, ve só as faltas    
                        ...
                        picFichas.Visible = false;
                        pictureBox12.Left = label12.Left = 25;
                        label12.Top = label1.Top;
                        pictureBox12.Top = pictureBox1.Top;
                        label12.Visible = true;
                        pictureBox12.Visible = true;
                        ...
                        label17.Left = picFichas.Left = picAnotacoes.Left + 120;
                        label17.Top = label1.Top;
                        label17.Visible = true;
                        picFichas.Top = pictureBox1.Top;
                        picFichas.Visible = true;
                        label18.Left = pictureBox17.Left = picFichas.Left + 120;
                        label18.Top = label1.Top;
                        label18.Visible = true;
                        pictureBox17.Top = pictureBox1.Top;
