...
namespace TeleBonifacio
{
    public static class glo
    {
        ...
        public static float LeValor(string valorTexto)
        {
            ...
            {
                glo.Loga($"Erro em LeValor: {ex.Message} | Valor: {valorTexto}");
                return 0.0f;
            }
        }        
        ...
        private static string RandomString(int length)
        {
            ...
            {
                glo.Loga($"Erro em RandomString: {ex.Message} | Length: {length}");
                return "ERROR";
            }
        }
        //private static string RandomString(int length)
        ...
        public static string GenerateUID()
        {
            ...
            {
                glo.Loga($"Erro em GenerateUID: {ex.Message}");
                return DateTime.Now.ToString("ddMMyyyyHHmmss") + "ERR";
            }
        }
        //public static string GenerateUID()
        //{
        ...
        public static void LogaErr(string message, string tipo)
        {
            MessageBox.Show(message, tipo, MessageBoxButtons.OK, MessageBoxIcon.Error);
            Loga(message);
        }
