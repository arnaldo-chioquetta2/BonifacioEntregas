...
{
    /// <summary>
    /// DAO responsável por consultas de totais e lançamentos do caixa.
    /// </summary>
    public class RelCaixaDAO
    {
        ...
        /// </summary>
        public TeleBonifacio.tb.Lancamento GetLancamento(int id)
        {
            const string sql = @"
        ...
        /// </summary>
        private TeleBonifacio.tb.Lancamento MapearLancamento(OleDbDataReader dr)
        {
            ...
            var lanc = new TeleBonifacio.tb.Lancamento
            {
                Id = dr["Id"] != DBNull.Value ? Convert.ToInt32(dr["Id"]) : 0,
                Data = dr["Data"] != DBNull.Value ? Convert.ToDateTime(dr["Data"]) : DateTime.MinValue,
        ...
        public List<TeleBonifacio.tb.Lancamento> FiltrarLancamentos(DateTime inicio, DateTime fim, string tipo)
        {
            var lista = new List<TeleBonifacio.tb.Lancamento>();
